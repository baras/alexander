...
<head>
    <title>Contact us -Alexander</title>
...
<div class="ui modal">
    ...
    <div class="content">
        ...
        <div class="right">
            <p>Integer et commodo arcu. Vestibulum varius felis aliquet, euismod erat id, imperdiet sem. Praesent nec
                adipiscing felis. Nullam congue ut tellus vitae pellentesque. Mauris aliquam hendrerit leo quis
                ullamcorper. Pellentesque ornare, lectus sed lacinia aliquam, libero velit dictum libero, sit amet
                tincidunt dui tortor a quam. Nullam pulvinar cursus eros, ut bibendum neque hendrerit id. Maecenas vitae
                pellentesque ligula. In ultricies, ligula elementum commodo viverra, nisl urna tincidunt nisi, non
                imperdiet arcu neque hendrerit erat. Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Pellentesque et eros consequat, dignissim nisi sit amet, adipiscing ante. Vestibulum ante ipsum primis
                in faucibus orci luctus et ultrices posuere cubilia Curae; Nam semper mi ante, sed ultricies odio
                adipiscing pretium. Praesent libero est, accumsan sed interdum nec, elementum gravida turpis. Vivamus
                tempus, quam eu pellentesque vestibulum, magna elit eleifend metus, vitae tristique nisi risus eu
                turpis. Ut vel ipsum sit amet elit laoreet vulputate. <a id="closemod" href="#"> Close </a></p>
...
<div class="ui segment orange raised">
    ...
    <div id="formdimmer" class="ui inverted dimmer">
        <div class="ui text loader small">Loading...</div>
    </div>
