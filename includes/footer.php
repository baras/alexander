...
<div id="footer">
    <div class="ui grid three column stackable">
        ...
        <div class="column">
            ...
            <p>Proin vitae laoreet nisl, faucibus cursus lectus. Sed vehicula vel lectus nec porttitor. Vestibulum
                scelerisque sollicitudin justo a sollicitudin.</p>
        </div>
        <div class="column">
            <div class="ui horizontal icon divider">
...
<script type="text/javascript" src="css/ui/semantic.min.js"></script>
